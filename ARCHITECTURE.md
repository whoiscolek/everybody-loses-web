# Everybody Loses v10.81 Architecture
...
The current application remains a large browser module. Decomposing `src/main.js` into domain modules is the next maintainability phase, but v10.81 intentionally avoids a high-risk wholesale rewrite during stabilization.
